...
for iii=[13, 15, 16, 17, 19, 21, 24, 26, 27, 29, 30, 34, 35, 36, 39, 40]
    ...
    if exist(strcat('C:\Users\kumar\Desktop\Ashutosh\Multilayer\',num2str(iii),'\EEG_AUNEW.mat')) == 2
        ...
        save(strcat('C:\Users\kumar\Desktop\Ashutosh\Multilayer\',num2str(iii),'\EEG_AUNEW_phase_ht_abs_ht.mat'), 'phase_ht_abs_ht_normalized', '-v7.3');
        completed = 0.33
    end
    ...
    if exist(strcat('C:\Users\kumar\Desktop\Ashutosh\Multilayer\',num2str(iii),'\EEG_AUOLD.mat')) == 2
        ...
        save(strcat('C:\Users\kumar\Desktop\Ashutosh\Multilayer\',num2str(iii),'\EEG_AUOLD_phase_ht_abs_ht.mat'), 'phase_ht_abs_ht_normalized', '-v7.3');
        completed = 0.66
    end
    ...
    if exist(strcat('C:\Users\kumar\Desktop\Ashutosh\Multilayer\',num2str(iii),'\EEG_OC.mat')) == 2
        ...
        save(strcat('C:\Users\kumar\Desktop\Ashutosh\Multilayer\',num2str(iii),'\EEG_OC_phase_ht_abs_ht.mat'), 'phase_ht_abs_ht_normalized', '-v7.3');
    end
    fin = 1
